...
def findCheapestPart(apiKey, year, make, model, part):
    ...
    headers = {
      ...
      "X-EBAY-C-MARKETPLACE-ID": "EBAY-US",  # setting the preferred marketplace
      "X-EBAY-C-ENDUSERCTX": "affiliateCampaignId=5338432561", #giving the greedy bastards at ebay more money
    }
    ...
    response = requests.get(baseUrl, headers=headers, params=paramaters)
...
if __name__ == "__main__":
    ...
    findCheapestPart(apiKey, year, make, model, part)